export const projects = [
  {
    ...
    tagline:
      "A sleek and modern survey collection app built with Flutter and Firebase.",
    overview:
      "A comprehensive survey collection application that allows users to collect and manage data from households, individuals, and trips.",
    features: [
  ...
  },
  {
    ...
    overview:
      "My personal portfolio is built to highlight my journey as a developer.",
    features: [
  ...
  },
  {
    ...
    tagline:
      "A modern web app for managing notes and bookmarks with tagging and search.",
    overview:
      "Notes & Bookmark Manager is a responsive web app that allows users to create, organize, and search their notes and bookmarks.",
    features: [
    ...
    feedback: true,
    links: {
      live: "https://personal-notes-and-bookmark-manager-ten.vercel.app/",
      github:
        "https://github.com/suraj-saw/Personal-Notes-and-Bookmark-Manager",
    },
  },

  {
    ...
    tagline:
      "A cross-platform plagiarism detection app using Flutter for UI and Node.js + Express for backend processing.",
    overview:
      "A cross-platform mobile and web application that detects plagiarism in text by comparing it against a database of reference documents stored in Supabase. Uses KMP string matching and trigram indexing with Porter stemming for accurate detection.",
    features: [
